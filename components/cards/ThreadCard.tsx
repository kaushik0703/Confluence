            ...
            <div className="flex items-start justify-between">
                <div className="flex w-full flex-1 flex-row gap-4">
                    <div className="flex flex-col items-center">
                        ...
                        <div className="thread-card_bar" /> {/* this is the line that connects the profile image to the content */}
                    </div>
                    ...
                    <div className="flex w-full flex-col">
                        ...
                        <div className={`${isComment && 'mb-10'} mt-5 flex flex-col gap-3`}>
                            ...
                            {isComment && comments.length > 0 && ( // comments on a particular comment
                                <Link href={`/thread/${id}`}>
                                    <p className="mt-1 text-subtle-medium text-gray-1">
                                        {comments.length>1? `${comments.length} replies`: `${comments.length} reply`}
                                    </p>
                                </Link>
                            )}
                        </div>
